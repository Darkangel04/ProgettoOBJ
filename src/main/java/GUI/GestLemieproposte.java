...
public class GestLemieproposte implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle resource){
        ...
        // Costruisce la query per ottenere le proposte dell'utente per una pagina specifica
        String titStoricoQuery = "SELECT proposta, visibile, accettata, sostituzione FROM tutte_proposte_utente("+ Controller.idutenteStatic +") WHERE pagina = '"+ Controller.titoloStatic.toUpperCase()+"';";
        ...
        try{
            ...
            while (queryOutput.next()){ // Itera sui risultati della query per salvarli
                String queryTesto = queryOutput.getString("proposta");
    ...
    public void backButtonOnAction(ActionEvent event) {
        try {
            // Carica la PaginaLeMieProposte.fxml in una nuova finestra
            ...
            // Chiudi la finestra corrente (PaginaGestLeMieProposte)
